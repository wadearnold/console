...
This project uses [Go Modules](https://github.com/golang/go/wiki/Modules) and uses Go 1.14 or higher. See [Golang's install instructions](https://golang.org/doc/install) for help setting up Go. You can download the source code and we offer [tagged and released versions](https://github.com/moov-io/console/releases/latest) as well. We highly recommend you use a tagged release for production.
...
$ midir -p moov/
$ cd moov/
$ git clone git@github.com:moov-io/console.git
```
...
First, [Fork our project](https://github.com/moov-io/console) somewhere and after that's done add the remote:

```
$ cd moov/console # Whereever this project's source code is

$ git remote add $user git@github.com:$user/console.git # After
...
Our Build pipeline utilizes [Travis-CI](https://travis-ci.org/moov-io/console) to enforce many tools that you should add to your editor before issuing a pull request. Learn more about these tools on our [Go Report card](https://goreportcard.com/report/github.com/moov-io/console)
